...
function useFeaturedProducts() {
  return useQuery({
    ...
    queryFn: () => getProducts({ limit: 8, sort: "rating" }),
    staleTime: 5 * 60 * 1000,
    retry: false,
  });
}
...
function HeroVisual() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -m-8 rounded-full bg-gradient-to-br from-primary/25 via-purple-500/20 to-primary/10 blur-3xl opacity-60 dark:opacity-80" />
      ...
      >
        ...
        >
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center shadow-glow-primary">
...
function HeroSection() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-primary/8 dark:bg-primary/15 blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              >
                <span className="absolute inset-0 rounded-full bg-gradient-to-r from-primary to-purple-600 transition-all group-hover:scale-105" />
      ...
      <section className="px-4 md:px-8 lg:px-16 py-20 bg-surface-2">
        <div className="max-w-7xl mx-auto">
          ...
          {!isLoading && !isError && products.length > 0 && (
            <div className="flex gap-6 overflow-x-auto pb-4 -mx-4 px-4 md:-mx-8 md:px-8 lg:-mx-0 lg:px-0 snap-x snap-mandatory scrollbar-hide">
